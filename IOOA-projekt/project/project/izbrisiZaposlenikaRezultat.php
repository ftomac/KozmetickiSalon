        ...
        <head>
            ...
            <div id="header" class="jumbotron text-center">
                ...
                if ($conn->connect_error) {
                    ...
                    $sql = "DELETE FROM Zaposlenici WHERE Ime = '" . $_POST['Ime'] ."'";
                    $sql2 = "DELETE FROM Termini WHERE Zaposlenik = '" . $_POST['Ime'] ."'";
                    if ($conn->query($sql) === TRUE && $conn->query($sql2) === TRUE) {
                        echo "Zaposlenik je uspjesno obrisan. <br />";
                        echo "<a href = 'adminLogin.php'>Go back</a>";
                    } else {
                        echo "Greska prilikom brisanja zaposlenika: " . $conn->error;
                    }
